  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          Visa Services by Gateway INC | Expert Assistance & Support
        </title>

        <meta
          name="description"
          content="Gateway INC offers expert visa services to facilitate your study abroad or immigration journey. Our services include visa application guidance, documentation assistance, and ensuring compliance with visa requirements, ensuring a smooth and successful visa application process."
        />
