...
export default function Accommodation({ homeData, serviceData }) {
  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Accommodation Services for Studying Abroad | Gateway INC</title>

        <meta
          name="description"
          content="Discover Gateway INC's expert accommodation services for students studying abroad. We ensure comfortable and convenient living arrangements near top universities, making your international study experience hassle-free."
        />
