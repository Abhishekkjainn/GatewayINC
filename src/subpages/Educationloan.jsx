...
export default function EducationLoan({ homeData, serviceData }) {
  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Education Loan Services for Studying Abroad | Gateway INC</title>

        <meta
          name="description"
          content="Explore Gateway INC's education loan services tailored for students aspiring to study abroad. We offer personalized guidance and assistance in securing affordable education loans, ensuring financial support for your international education journey."
        />
