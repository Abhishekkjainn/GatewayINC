  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          PTE Exam Preparation by Gateway INC | Expert Guidance & Courses
        </title>

        <meta
          name="description"
          content="Prepare for the PTE exam with Gateway INC's expert guidance and comprehensive courses. Our tailored programs focus on all exam sections, ensuring thorough preparation to help you achieve your desired score for study abroad or immigration purposes."
        />
