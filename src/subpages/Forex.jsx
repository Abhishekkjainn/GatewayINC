...
export default function ForexServices({ homeData, serviceData }) {
  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Forex Services for Studying Abroad | Gateway INC</title>

        <meta
          name="description"
          content="Gateway INC offers specialized forex services for students studying abroad. We provide competitive exchange rates, currency conversion assistance, and financial planning to ensure seamless transactions and financial support throughout your international study journey."
        />
