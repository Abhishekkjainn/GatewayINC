  ...
  return (
    <div className="canadapage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          SOP and LOR Writing Services by Gateway INC | Expert Guidance &
          Support
        </title>

        <meta
          name="description"
          content="Gateway INC offers professional SOP and LOR writing services to help you secure admissions to top universities abroad. Our expert writers provide personalized guidance and support, crafting compelling statements and letters that highlight your strengths and aspirations."
        />
