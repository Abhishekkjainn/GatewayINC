  ...
  return (
    <div className="canadapage">
      <Helmet>
        ...
        <title>Book Air Tickets for Study Abroad | Gateway INC</title>

        <meta
          name="description"
          content="Explore Gateway INC's air ticket booking services tailored for students studying abroad. Find affordable flights to top destinations worldwide, ensuring convenient travel arrangements for your international study journey."
        />
